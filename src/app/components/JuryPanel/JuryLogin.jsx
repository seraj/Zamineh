...
class JuryLogin extends React.Component {
    ...
    loginSubmit = values => {
        ...
        axios
            .post(`${Urls().api()}${this.props.loginAPI}`, {
                client_id: cookie.load('jury_auth_client_id', { path: Urls().JuryPanel() }),
                client_secret: cookie.load('jury_auth_client_secret', { path: Urls().JuryPanel() }),
                username: this.state.username,
                password: values.password,
                grant_type: 'password',
                user_type: this.props.type
