            ...
            <Col xs="12" lg="12" md="12" sm="12" className="mobileLogin">
              {!isLogined && (
                <div className="mobile-login-btn right">
                  <button className="zbtn" onClick={() => openModal(true)}>
        ...
        >
          <Row>
            <Col lg={6} md={6} sm={6} xs={12}>
              <a href={Urls().ArtistPanel()} onClick={this.closeRegisterModal}>
                <button
            ...
            <Col lg={6} md={6} sm={6} xs={12}>
              <a href={Urls().GalleryPanel()} onClick={this.closeRegisterModal}>
                <button style={{ width: "100%" }} className={`zbtn gallery`}>
                  {/*<GalleryIcon />*/}
                  ثبت گالری
                </button>
              </a>
