...
class AuthorizationForm extends React.Component {
  ...
  componentDidMount() {
    if (
      this.MobileValidatorboolean(
        queryString.parse(location.search)["zB5up7HQTL24vsna"]
      )
    ) {
      this.setState({
  ...
  onCheckMobileNumberClick = async values => {
    ...
    axios
      .post(`${Urls().api()}${this.props.checkMobileAPI}`, {
  ...
  adapt = Component => ({ input, meta: { valid, touched }, ...rest }) => (
                  ...
                  <form onSubmit={handleSubmit} autoComplete="off">
                    ...
                    <FormGroup>
                      ...
                      <Field
                        ...
                        validate={value =>
                          value ? undefined : "وارد کردن کد تایید الزامی میباشد"
                        }
                        control
                      />
                      <Error name="code" />
                    ...
                    <FormGroup>
                      ...
                      <Field
                        ...
                        validate={value =>
                          value ? undefined : "وارد کردن نام کامل الزامی میباشد"
                        }
                        control
                      />
                      <Error name="password" />
