        ...
        if (error.response.status == 406) {
          this.setState({
            ...
            message: {
              ...
              message:
                "شما با این شماره یک گالری ثبت کرده اید.در صورت نیاز شما میتوانید با شماره‌ی دیگر ثبت نام کنید"
            },
            timer: 5
          });
        }
  ...
  handleFormSubmit = values => {
    ...
    if (!this.Validation(values)) {
      ...
      FormData.address.lat == null
        ? this.state.Maplatlng.lat == "" ||
          this.state.Maplatlng.lat == undefined
      ...
      axios
        .post(
          `${Urls().api()}/gallery-app/gallery/registration/`,
          {
            name: values.name,
            about: values.about,
            address: {
        ...
        .then(() => {
          ...
          this.setState({
            ...
            message: {
              ...
              message:
                "گالری مورد نظر ثبت شده.بزودی به صفحه پروفایل انتقال میابید."
            },
            timer: 15
          });
        })
