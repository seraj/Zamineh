                                                                            ...
                                                                            <RadioGroup>
                                                                                ...
                                                                                <FormCheck inline>
                                                                                    <Field
                                                                                        ...
                                                                                        hidden
                                                                                        id='collection_set'
                                                                                        value='collection_set'
                                                                                        onChange={() => this.onChangeType('collection_set')}
                                                                                    />
                                                                                    <FormCheckLabel htmlFor='collection_set' className={`${type == 'collection_set' ? `checked` : ``} ${loadingDiv == 'collection_set' ? `spinning` : ``}`}>مجموعه</FormCheckLabel>
                                                                                </FormCheck>
                                                                            </RadioGroup>
                                                                        </div>
                                                                    </FormGroup>
